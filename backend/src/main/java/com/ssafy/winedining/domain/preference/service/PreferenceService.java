...
public class PreferenceService {
    ...
    public void saveUserPreferenceTest(Long userId, PreferenceTestRequest preferenceTest){
        ...
        Preference userPreference = Preference.builder()
                .userId(userId)
                .alcoholContent(preferenceTest.getAlcoholDegree())
                ...
                .red(preferenceTest.getPreferredTypes().contains("red"))
                .white(preferenceTest.getPreferredTypes().contains("white"))
                .sparkling(preferenceTest.getPreferredTypes().contains("sparkling"))
                .rose(preferenceTest.getPreferredTypes().contains("rose"))
                .fortified(preferenceTest.getPreferredTypes().contains("fortified"))
                .etc(preferenceTest.getPreferredTypes().contains("etc"))
